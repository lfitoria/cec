 ...
 */
final class Version20191021210422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_733CE9B264C19C1 ON eval_request (category)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_733CE9B264C19C1 ON eval_request');
    }
}
