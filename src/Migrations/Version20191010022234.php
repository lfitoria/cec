 ...
 */
final class Version20191010022234 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE work_log ADD observations VARCHAR(200) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE work_log DROP FOREIGN KEY FK_F5513F59A76ED395');
        $this->addSql('ALTER TABLE work_log DROP observations');
