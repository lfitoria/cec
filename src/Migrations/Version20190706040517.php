...
final class Version20190706040517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inst_auth_files_project (projectrequest_id INT NOT NULL, file_id INT NOT NULL, INDEX IDX_46E980D51EDE5C6F (projectrequest_id), INDEX IDX_46E980D593CB796C (file_id), PRIMARY KEY(projectrequest_id, file_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE human_info_files_project (projectrequest_id INT NOT NULL, file_id INT NOT NULL, INDEX IDX_F29FB07F1EDE5C6F (projectrequest_id), INDEX IDX_F29FB07F93CB796C (file_id), PRIMARY KEY(projectrequest_id, file_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
